...
BASE=(rtl/fugue_pkg.sv rtl/kv_tlb_pkg.sv rtl/fp16_mult.sv rtl/fp16_add.sv rtl/dbuf_16x256.sv rtl/fp32_add.sv rtl/fp32_mul.sv rtl/fp32_exp.sv rtl/fp32_recip.sv rtl/gemv_unit.sv rtl/accumulator.sv rtl/softmax_unit.sv rtl/attacc_controller.sv)
KV=(rtl/kv_seg_tlb.sv rtl/kv_ptw.sv rtl/kv_scan_planner.sv rtl/kv_tlb_top.sv)
elab attacc_logic_die attacc_logic_die "${BASE[@]}" rtl/direct_addr_plan.sv rtl/attacc_logic_die.sv
elab fugue2_logic_die fugue2_logic_die "${BASE[@]}" "${KV[@]}" rtl/diff_decoder.sv rtl/fugue2_logic_die.sv
elab fugue_logic_die fugue_logic_die "${BASE[@]}" rtl/bf16_mult.sv rtl/bf16_add.sv rtl/sincos_bf16.sv rtl/rotate_q_bf16.sv "${KV[@]}" rtl/diff_decoder.sv rtl/fugue_logic_die.sv
elab fugue_mq_a8 fugue_mq_a8 "${BASE[@]}" "${KV[@]}" rtl/mq_diff_decoder.sv rtl/fugue_mq_logic_die.sv
elab kv_tlb_e16 kv_tlb_e16 rtl/kv_tlb_pkg.sv "${KV[@]}" rtl/kv_tlb_variants.sv
elab kv_tlb_e32 kv_tlb_e32 rtl/kv_tlb_pkg.sv "${KV[@]}" rtl/kv_tlb_variants.sv
elab kv_tlb_e64 kv_tlb_e64 rtl/kv_tlb_pkg.sv "${KV[@]}" rtl/kv_tlb_variants.sv
