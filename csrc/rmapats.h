...
extern "C" {
#endif
void  rmaPropagate0_tb_acc_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_tb_acc_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_tb_acc_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_tb_acc_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_tb_acc_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_tb_acc_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_tb_acc_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_tb_acc_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_tb_acc_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_tb_acc_daidir (UB  * pcode, scalar  val);
