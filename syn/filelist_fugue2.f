# Fugue 2 logic die — RoPE on the GPU; die adds only TLB + diff_decoder over
# the AttAcc baseline (no on-die rotate unit).
...
/data2/chenyi9/KV-PIM/fugue-logic-die-rtl/rtl/fugue2_logic_die.sv
